...
var SummaryComponent = (function () {
    ...
    SummaryComponent.prototype.getResults = function () {
        ...
        players.forEach(function (p) {
            var arr = results.map(function (r) { return r[p.id]; });
            arr = _this.totalTransform(arr);
            playerRecords.push([p.name].concat(arr));
        ...
        var chart = __WEBPACK_IMPORTED_MODULE_4_c3__["generate"]({
            bindto: '#chart',
            data: {
    ...
    SummaryComponent.prototype.totalTransform = function (arr) {
        var total = 0;
        var newArr = [];
